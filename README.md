...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/chengcct/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
...
*   **反馈:** [提交 issue](https://github.com/chengcct/v2ray-agent/issues)
